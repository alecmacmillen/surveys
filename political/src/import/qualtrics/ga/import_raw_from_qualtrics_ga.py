...
OUT_PATH_ROOT = '../../../../data/raw/ga/'
SCRAPE_COLS = ['response_id', 'recorded_date', 'duration', 'long', 'lat', 'registered', 
               'propensity', 'pres', 'sen2', 'sen3', 'gender', 'age', 'hhinc',
               'hisp', 'race', 'educ', 'pres16', 'gov18', 'county', 'random_id', 'ip_address']
...
def convert_and_export(rows, survey_id, extension1, extension2):
    ...
    response_cols = ['survey_id', 'response_id', 'registered', 'propensity',
                     'pres', 'sen2', 'sen3', 'gender', 'age', 'hhinc',
                     'hisp', 'race', 'educ', 'pres16', 'gov18', 'county', 'ip_address']
